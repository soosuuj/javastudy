...
public class MainWrapper {
  ...
  public static void main(String[] args) {
     ...
     *  키워드 규칙
     *   1. 프로젝트 : 맘대로 
     *   2. 패키지   : 모두 소문자로 작성(실무는 회사 도메인을 거꾸로 작성 : com.sansung.xxx)
     ...
     *   6. 상수     : Snake Camel Case (대문자를 밑줄로 연결)
     */
    ...
    int score =100;
    long money  = 1000000000; //뒤에 숫자를 보고 21억이 넘어가면 L붙이고, 아니면 붙이지 않아도 된다.
    System.out.println(score);
    System.out.println(money);
    
    // primitive type -4 : 실수타입
    double commition = 0.5;
