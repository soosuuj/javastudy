...
public class MainWapper {
  ...
  public static void ex01() {
   ...
   // System.out.println(a[5]);  // 인덱스의 범위를 벗어난 배열 요소 : 예외발생
   ...
   * 2. 중괄호({})를 이용해서 초기화 하고자 하는 값을 지겅할 수 있다.
   * 3. 배열의 초기화는 배열을 선언할 때만 사용할 수 있다. 
   * 4. 형식
   *    int[] a = {10, 20, 30}; 값을 원하는 만큼 전달
   *    
   */
  ...
  public static void ex06() {
    ...
    //배열명 확인
    System.out.println(a);  //[I@3d012ddd - 배열의 참조 값(주소값)이 나옴
  }
