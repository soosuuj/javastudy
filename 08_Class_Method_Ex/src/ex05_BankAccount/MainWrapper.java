...
public class MainWrapper {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("계설지점 : " + member1.getAcc().getBank().getName());
    ...
    Bank bank2 = new Bank();
    bank2.setName("농협");
    bank2.setTel("02-1111-2222");
    
    BankAccount acc2 = new BankAccount();
    acc2.setBank(bank2);
    acc2.setAccNo("987-654-321");
    ...
    System.out.println("계설지점 : " + member2.getAcc().getBank().getName());
